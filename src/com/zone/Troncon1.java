...
public class Troncon1 extends JPanel implements ElementRoute {
	...
	public static void genVoitures() {
		int voituresMin;
		int voituresMax;
		if (ConfigurationVoitures.getTron1Debut() != 0) {
			voituresMin = ConfigurationVoitures.getTron1Debut();
			voituresMax = ConfigurationVoitures.getTron1Debut();
	...
	// Fonction qui ajoute une voiture au array de voitures
		...
		public static void ajoutVoitures() {
			...
			lblVoituresTR1.setText("Voitures sur la Troncon1 : " + (FilAttente.size()));
		};
	...
	public static void resetVoitures() {
		FilAttente.clear();
		lblVoituresTR1.setText("Voitures sur le Troncon1 : ");
	};
